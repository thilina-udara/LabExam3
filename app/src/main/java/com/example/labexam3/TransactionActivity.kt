...
class TransactionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Highlight the Transactions navigation item
        BottomNavHelper.updateSelectedNav(this, R.id.navTransactions)
    }
    ...
    override fun onResume() {
        ...
        // Re-highlight the Transactions navigation item when returning to this activity
        BottomNavHelper.updateSelectedNav(this, R.id.navTransactions)
    }
